...
export type { SmartChainSFT } from "./contracts/smartChain.sol/SmartChainSFT";
export { SmartChainSFT__factory } from "./factories/contracts/smartChain.sol/SmartChainSFT__factory";
